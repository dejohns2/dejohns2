...
I’m a **computer programming educator with decades of hands-on IT experience**—bridging the gap between **industry expectations** and **classroom learning**.

Before teaching, I worked across multiple IT roles including **software analysis, application development, and project management**, supporting systems used by world market leaders. My experience spans the full technology spectrum—from **microcomputer support** to **enterprise-level software solutions**.
...
👉 [View my Credly badges](https://www.credly.com/users/deborah-johnson.084a1f28/badges#credly)

---

## 🎓 Education

- **M.S.**, IT Management — Wayne State College (2016)  
- **B.A.**, Computer Information Systems / Web Analyst — Wayne State College (2014)  
- **A.A.** — Northeast Community College (2014)  
- **A.A.S.**, Computer Programming — Northeast Community College (1984)

---

## 🌱 Teaching Philosophy

I believe effective programming education must reflect the realities of the workplace.
